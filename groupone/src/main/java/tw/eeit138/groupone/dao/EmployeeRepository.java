...
public interface EmployeeRepository extends JpaRepository<EmployeeBean, Integer> {
	...
	//找部門編號及職稱編號(下拉式改變部門，主管欄位也會根據不同部門而改變主管名)
	...
	public List<EmployeeBean> selectSuperiorName(@Param(value = "empId") Integer empId,@Param(value = "departId") String departId,@Param(value = "titleId") String titleId);
	...
	public void adminUpdateEmpInformation(
			@Param(value = "empId") Integer empId,
			@Param(value = "photo") String photo,
			@Param(value = "username") String username,
			@Param(value = "birthday") String birthday,
			@Param(value = "deptno") String fkDepartmentDeptno,
			@Param(value = "titleId") String fkTitleId,
			@Param(value = "contact") String sex,
			@Param(value = "superiorName") String superiorName,
			@Param(value = "id") String id,
			@Param(value = "phone") String phone,
			@Param(value = "highEdu") String highEdu,
			@Param(value = "highLevel") String highLevel,
			@Param(value = "highMajor") String highMajor,
			@Param(value = "emergencyContact") String emergencyContact,
			@Param(value = "contactRelationship") String contactRelationship,
			@Param(value = "contactPhone") String contactPhone,
			@Param(value = "address") String address,
			@Param(value = "email") String email,
			@Param(value = "fkStateId") String fkStateId
			);
	
	
	//管理員修改員工基本資料
	@Modifying
	@Query(value = "update employee set photo=:photo,birthday=:birthday,username=:username,fkDepartmentDeptno=:deptno,sex=:contact,fkTitleId=:titleId,superiorName=:superiorName,id=:id,phone=:phone,highEdu=:highEdu,highLevel=:highLevel,highMajor=:highMajor,emergencyContact=:emergencyContact,contactRelationship=:contactRelationship,contactPhone=:contactPhone,address=:address,email=:email where empId=:empId",nativeQuery = true)
	public void empUpdateInformation(
			@Param(value = "empId") Integer empId,
			@Param(value = "photo") String photo,
			@Param(value = "username") String username,
			@Param(value = "birthday") String birthday,
