						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<br><br>
									<form:form class="form" action="${contextRoot}/Post"
										...
										<p/><br>
										<label class="post-title">內容</label>
										<form:textarea id="postcontent" name="postcontent" path="Postcontent" class="form-control"
										...
										<a href="${contextRoot}/barindex"><button type="button" class="btn btn-primary" >取消</button></a>
									</form:form>
								</div>
							</div>
						</div>
